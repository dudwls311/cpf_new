...
public class PatternUtil {
	...
	public static final String patternDateHyphen = "^(19|20)\\d{2}\\-(0[1-9]|1[012])\\-(0[1-9]|[12][0-9]|3[0-1])$";//date(yyyy-MM-dd)
	...
	public static boolean isDateHyphen(String str) {
		...
		Matcher match = Pattern.compile(patternDateHyphen).matcher(str);
		if (match.find()) {
			chk = true;
		}
		return chk;
