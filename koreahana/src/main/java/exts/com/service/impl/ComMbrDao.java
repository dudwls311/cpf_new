...
//		return (String) select(namespace + "selectEncodePw", pw);
	 ...
	 * @throws Exception
	 */
	public void updateComMbrUpdateUserKey(ComMbrVO searchVO) {
		update(namespace + "updateUserKey", searchVO);
	}
	 ...
	 * @throws Exception
	 */
	public void mergeKoreahanaMbrAdt(ComMbrVO searchVO) {
		update(namespace + "mergeMbrAdt", searchVO);
	}
	// //////////////////////서비스 메소드 선언 영역 끝 ///////////////////////////////////////////////////////////////////
