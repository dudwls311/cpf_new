...
/**
 * @Class Name : KoreahanaMbrPwChangeValidator.java
 ...
 */
@Component("koreahanaMbrPwChangeValidator")
public class KoreahanaMbrPwChangeValidator extends ExtsAbstractValidator implements Validator {
	//validate체크할  field들
