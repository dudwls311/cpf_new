...
/**
 * @Class Name : KoreahanaFthMtrValidator.java
 * @Description : 미래행복통장만기해지 Validator
...
@Component("koreahanaFthMtrValidator")
public class KoreahanaFthMtrValidator extends ExtsAbstractValidator implements Validator {
	//validate체크할  field들
	...
	private static final String usdusgCd = "usdusgCd";		//사용처코드
	...
	public void validate(final Object obj, final Errors errors) {
		...
		ValidationUtils.rejectIfEmptyOrWhitespace(errors,usdusgCd, REQUIRED_FIELD, makeMessage(usdusgCd, REQUIRED_FIELD));		//사용처코드
