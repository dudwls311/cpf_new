...
/**
 * @Class Name : KoreahanaMgmValidator.java
 * @Description : 경영개선자금지원 Validator
...
@Component("koreahanaMgmValidator")
public class KoreahanaMgmValidator extends ExtsAbstractValidator implements Validator {
	//validate체크할  field들
	...
	private static final String rrnoBknb = "rrnoBknb";		//주민등록번호
...
//		if("".equals(comCodeService.getCd(bzstatCdList, command.getBizstatCd())))errors.rejectValue(bzstatCd, INVALID_CODE_NAME_FIELD, makeMessage(bzstatCd,INVALID_CODE_NAME_FIELD));
