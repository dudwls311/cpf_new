	...
	//				}
				...
				if(localVO.getBoardinfoVO().getUseSms() == 1){
					...
					*/
					...
					smsVO.setTargetNumber(phoneTo);
					smsVO.setSendNumber(Globals.SMS_SEND_NUMBER);
					smsVO.setSendTitle(localVO.getBoardinfoVO().getBoardTitle());
					smsVO.setSendMessage(smsMsg);
