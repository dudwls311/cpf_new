					...
					<table class="board_view tbl_layout_fix">
						<colgroup>
							...
							<tr>
								...
								<td>
									<input type="text" class="text" id="inPkg" name="inPkg" value="exts.koreahana." placeholder="ex) exts.koreahana.com" />
								</td>
							</tr>
							<tr>
								<th scope="row">JAVA 파일명</th>
								<td>
									<input type="text" class="text" id="inFileName" name="inFileName" value="Koreahana" placeholder="ex) KoreahanaCom" />
								</td>
							</tr>
							<tr>
