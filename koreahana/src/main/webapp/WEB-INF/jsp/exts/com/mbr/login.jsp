...
<div id="wrap">
	<!-- Sample S 이상 -->
	<div class="login_box">
		<h1><strong class="logo"><a href="/index.do"><img src="/support/img/common/logo_h1.png" alt="남북하나재단"></a></strong></h1>	
		<h2>북한이탈주민지원재단 온라인신청시스템<br><b>지원사업관리</b></h2>
