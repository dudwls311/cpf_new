...
<script type="text/javascript" src="/resources/js/exts/koreahana/spf/spfExcelUpload.js"></script>
	...
	<table class="table_style">
		<thead>
			<tr>
				...
				<th scope="col">종사기관유형</th>
				<th scope="col">북한이탈주민 정착 지원 실무 경력</th>
				<th scope="col">신청 동기 및  기대 효과  </th>
				<th scope="col">이전교육수료일</th>
			</tr>
		</thead>
