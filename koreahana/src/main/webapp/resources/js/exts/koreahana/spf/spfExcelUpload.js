	...
	$.ajax({
		...
		success:function(resultData){
			...
			for(var i=0; i<resultData.length; i++){
				...
				html += '	</td>';
				html += '	<td>' + ComFns.convertText(_data.vo.bizSeCd) + '</td>';
				html += '	<td' + (_err.sprtSn.length > 0?' class="error"':'') + '>' ;
				...
				html += '	</td>';
				html += '	<td' + (_err.exslno.length > 0?' class="error"':'') + '>' ;
				html += 		ComFns.convertText(_data.vo.exslno);
				html += 		(_err.exslno.length > 0?'<span class="tooltip">' + ComFns.printErrorArrayMessage(_err.exslno) + '</span>':'') ;
				html += '	</td>';
				...
				html += '	<td>' + ComFns.convertText(_data.vo.ordpNm) + '</td>';
				html += '	<td>' + ComFns.convertText(_data.vo.eml) + '</td>';
				html += '	<td>' + ComFns.convertText(_data.vo.lastAcbgCd) + '</td>';
				html += '	<td>' + ComFns.convertText(_data.vo.ocptInstTypeCd) + '</td>';
				html += '	<td>' + ComFns.convertText(_data.vo.ptexp) + '</td>';
				html += '	<td>' + ComFns.convertText(_data.vo.aplyMtv) + '</td>';
				html += '	<td>' + ComFns.convertText(_data.vo.eduFnshYmd) + '</td>';
				html += '</tr>';
			}
