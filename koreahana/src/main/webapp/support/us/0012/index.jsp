<% response.setHeader("Cache-Control","no-store"); response.setHeader("Pragma","no-cache"); response.setDateHeader("Expires",0); if (request.getProtocol().equals("HTTP/1.1")) { response.setHeader("Cache-Control", "no-cache"); } %><%@ page contentType="text/html; charset=utf-8" %><%@ include file='/_common/header.jsp' %><%@ include file='/support/_tpls/B/TPL_000003_S.jsp' %><% /*<!-- [-CONTENT-] -->*/ %><div class="con_b_tp">
...
<table class="table_style thd_v_m">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="AlignLeft"><a href="#" class="btn_a">2022년 버스운전기사 양성과정 참가자 모집 공고</a></td>
      <td>yyyy-mm-dd hh:mm:ss</td>
      <td class="td_bg"><span class="txt_c_bl"><b>선정</b></span> <a href="#" class="btn_st btn_c_bl">수험표 인쇄</a></td>
      <td><a href="#" class="btn_st btn_c_wh">수정</a></td>
    </tr>
    <tr>
      <td>5</td>
    ...
    <tr>
      ...
      <td class="AlignLeft"><a href="#" class="btn_a">2022년 버스운전기사 양성과정 참가자 모집 공고</a></td>
      <td>yyyy-mm-dd hh:mm:ss</td>
      <td class="td_bg"><span class="txt_c_re"><b>서류미비</b></span> <a href="#" class="btn_st btn_c_re">서류확인</a></td>
      <td><a href="#" class="btn_st btn_c_wh">수정</a></td>
    </tr>
  </tbody>
</table>
