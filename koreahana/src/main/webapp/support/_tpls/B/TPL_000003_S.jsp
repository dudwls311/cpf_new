    ...
    <div id="wrap">
      ...
      <div class="sub_visual">
        <div class="container">
          ...
          <a href="#none" target="_blank" title="새 창으로 열림" class="site_help_btn" onclick="fnHelpPopup('<c:out value="${pageContext.request.requestURI}" />');return false;">화면도우미</a>
        </div>
      </div>
