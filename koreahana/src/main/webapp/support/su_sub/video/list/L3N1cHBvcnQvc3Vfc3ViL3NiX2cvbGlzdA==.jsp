<% response.setHeader("Cache-Control","no-store"); response.setHeader("Pragma","no-cache"); response.setDateHeader("Expires",0); if (request.getProtocol().equals("HTTP/1.1")) { response.setHeader("Cache-Control", "no-cache"); } %><%@ page contentType="text/html; charset=utf-8" %><%@ include file='/_common/header.jsp' %><%@ include file='/support/_tpls/B/TPL_000003_S.jsp' %><% /*<!-- [-CONTENT-] -->*/ %><div class="page_tip">북한이탈주민의 초기정착을 돕고자 마련된 정착금의 일종으로 남북하나재단에서는 장애, 장기치료, 제3국 출생 자녀양육가산금을 지원하고 있습니다.
  ...
  <div class="con_b_tp">
    ...
    <div class="FloatRight"><input type="text" name="isWord2" id="isWord2" class="st_input MAL10 PAR25" value="" />
  ...
  <table class="table_style thd_v_m">
    ...
    <tbody>
      <tr>
        <td>10</td>
        <td>장애</td>
        <td class="AlignLeft"><a href="/support/su_sub/sb_g/view/" class="btn_a">2022년 하반기 가산금(장애, 장기치료, 제3국 출생 자녀양육)지원 대상자 모집</a></td>
        <td>상시모집</td>
        <td class="td_bg"><a class="btn_st btn_c_gr" href="/support/su_sub/sb_g/write/">신청하기</a></td>
      </tr>
