<% response.setHeader("Cache-Control","no-store"); response.setHeader("Pragma","no-cache"); response.setDateHeader("Expires",0); if (request.getProtocol().equals("HTTP/1.1")) { response.setHeader("Cache-Control", "no-cache"); } %><%@ page contentType="text/html; charset=utf-8" %><%@ include file='/_common/header.jsp' %><%@ include file='/support/_tpls/B/TPL_000003_S.jsp' %><% /*<!-- [-CONTENT-] -->*/ %><c:import url="/user/exts/koreahana/edu/index.do" />

<%--
<div class="page_tip">탈북 대학생의 교육지원(등록금 면제 또는 등록금 50% 보조)지원의 일환으로 등록금을 지원하고 있습니다. 교육지원금의 경우 각 대학별 모집을 통해 신청 할 수 있습니다. 
...
<table class="table_style thd_v_m">
  ...
  <tbody>
    <tr>
      <td>10</td>
      <td class="AlignLeft"><a href="/support/su_sub/suppay/view/" class="btn_a">2022년도 상반기 북한이탈주민 교육지원 안내(대학)</a></td>
      <td>상시모집</td>
      <td class="td_bg"><a class="btn_st btn_c_gr" href="/support/su_sub/suppay/write/">신청하기</a></td>
    </tr>
