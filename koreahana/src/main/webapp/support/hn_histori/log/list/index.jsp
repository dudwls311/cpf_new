<% response.setHeader("Cache-Control","no-store"); response.setHeader("Pragma","no-cache"); response.setDateHeader("Expires",0); if (request.getProtocol().equals("HTTP/1.1")) { response.setHeader("Cache-Control", "no-cache"); } %><%@ page contentType="text/html; charset=utf-8" %><%@ include file='/_common/header.jsp' %><%@ include file='/support/_tpls/B/TPL_000019_S.jsp' %><% /*<!-- [-CONTENT-] -->*/ %><div class="box_w_gray MAB10">
  ...
  <select name="aaa11" id="aaa11" class="st_select">
    ...
    <option>화상영어</option> 
    <option>학습지</option> 
    <option>정착지원 전문관리사</option> 
    <option>취업바우처카드</option> 
    <option>미래행복통장</option> 
    <option>취업연계 직업훈련</option> 
    <option>경영개선자금</option> 
    <option>영농정착</option> 
  ...
  <input type="text" name="aaa13" id="aaa13" class="st_input i_w95" value="" placeholder="yyyy-mm-dd"/>
  ...
  <input type="text" name="aaa15" id="aaa15" class="st_input i_w95" value=""  placeholder="yyyy-mm-dd"/>
  <label for="aaa16" class="MAL20">보호결정일</label>
  <input type="text" name="aaa16" id="aaa16" class="st_input i_w95" value=""  placeholder="yyyy-mm-dd"/>
  ...
  <input type="text" name="aaa18" id="aaa18" class="st_input i_w95" value=""  placeholder="yyyy-mm-dd"/>
...
<table class="table_style">
  ...
  <tbody>
    <tr>
      ...
      <td>yyyy-mm-dd</td>
      <td>yyyy-mm-dd</td>
      <td><a href="#none" class="btn_st">상세보기</a></td>
    </tr>
    <tr>
      <td>4</td>
      <td>홍길동</td>
