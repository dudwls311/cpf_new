    ...
    <div id="wrap">
      ...
      <div class="sub_visual">
        <div class="container">
          ...
          <%= JnitcmsmenuController.getMenuJSON("pageLinkNav") %>          <a href="#none" target="_blank" title="새 창으로 열림" class="site_help_btn">화면도우미</a><!-- 탭이 아니라 창이 떠야하려나요-->
        </div>
      </div>
