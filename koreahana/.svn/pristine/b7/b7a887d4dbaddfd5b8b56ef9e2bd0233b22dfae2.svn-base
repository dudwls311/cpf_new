...
/**
 * @Class Name : KoreahanaFthExcelValidator.java
 * @Description : 미래행복통장신규신청 엑셀 업로드 Validator
...
@Component("koreahanaFthNewExcelValidator")
public class KoreahanaFthNewExcelValidator extends ExtsAbstractValidator implements Validator {
	...
	public void validate(final Object obj, final Errors errors) {
		...
		if("".equals(comCodeService.getCd(ageCdList, command.getAgeCd())))errors.rejectValue(ageCd, INVALID_CODE_NAME_FIELD, makeMessage(ageCd,INVALID_CODE_NAME_FIELD));
		...
		if("".equals(comCodeService.getCd(ecnmatCdList, command.getEcnmatCd())))errors.rejectValue(ecnmatCd, INVALID_CODE_NAME_FIELD, makeMessage(ecnmatCd,INVALID_CODE_NAME_FIELD));
//		ValidationUtils.rejectIfEmptyOrWhitespace(errors,crCd, REQUIRED_FIELD, makeMessage(crCd, REQUIRED_FIELD));		//직업군코드
		if(!"".equals(NullUtil.nullString(command.getCrCd())) && "".equals(comCodeService.getCd(crCdList, command.getCrCd())))errors.rejectValue(crCd, INVALID_CODE_NAME_FIELD, makeMessage(crCd,INVALID_CODE_NAME_FIELD));
...
//		ValidationUtils.rejectIfEmptyOrWhitespace(errors,prtprdExtsnCd, REQUIRED_FIELD, makeMessage(prtprdExtsnCd, REQUIRED_FIELD));		//보호기간연장코드
		if(!"".equals(NullUtil.nullString(command.getPrtprdExtsnCd())) && "".equals(comCodeService.getCd(prtprdExtsnCdList, command.getPrtprdExtsnCd())))errors.rejectValue(prtprdExtsnCd, INVALID_CODE_NAME_FIELD, makeMessage(prtprdExtsnCd,INVALID_CODE_NAME_FIELD));
