...
<script type="text/javascript" src="/resources/js/exts/koreahana/vdo/vdoExcelUpload.js"></script>
<form id="writeForm" action="${actionUrl }" method="post">
	<input type="hidden" name="kvMode" value="excelUploadActionJson" />
</form>
<form id="validationForm" action="${actionUrl }" method="post">
	<input type="hidden" name="kvMode" value="excelValidationActionJson" />
</form>
