...
<script type="text/javascript" src="/resources/js/exts/koreahana/fth/fthMdwExcelUpload.js"></script>
...
<h4 class="tit">미래행복통장 중도해지 일괄등록</h4>
<div class="box_w_wht">
...
<div class="MAB10">
	...
	<span class="FloatRight MAB5">
		...
		<a href="#" class="btn_st btn_c_gr" onclick="ComFns.sampleDownload('fthMdw.xlsx','미래행복통장중도해지샘플.xlsx');return false;">업로드샘플파일 다운로드</a>
	</span>
</div>
	...
	<table class="table_style">
		<thead>
			<tr>
				...
				<th scope="col">하나센터 담당자</th>
				<th scope="col">통장 가입일</th>
				<th scope="col">가입기간(개월)</th>
				<th scope="col">해지사유</th>
				<th scope="col">본인적립금(만원단위)</th>
				<th scope="col">재단적립금(만원단위)</th>
