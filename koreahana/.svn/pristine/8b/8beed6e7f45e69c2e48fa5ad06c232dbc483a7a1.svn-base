...
/**
 * @Class Name : KoreahanaFthMdwValidator.java
 * @Description : 미래행복통장중도해지 Validator
...
@Component("koreahanaFthMdwValidator")
public class KoreahanaFthMdwValidator extends ExtsAbstractValidator implements Validator {
	//validate체크할  field들
