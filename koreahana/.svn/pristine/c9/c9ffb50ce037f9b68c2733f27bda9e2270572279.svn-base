...
<script type="text/javascript" src="/resources/js/exts/koreahana/emv/emvUseExcelUpload.js"></script>
<form id="writeForm" action="${actionUrl }" method="post">
	<input type="hidden" name="keuMode" value="excelUploadActionJson" />
</form>
<form id="validationForm" action="${actionUrl }" method="post">
	<input type="hidden" name="keuMode" value="excelValidationActionJson" />
</form>
...
<h4 class="tit">취업바우처카드 지급정보 일괄등록</h4>
<div class="box_w_wht">
...
<div class="MAB10">
	...
	<span class="FloatRight MAB5">
		...
		<a href="#" class="btn_st btn_c_gr" onclick="ComFns.sampleDownload('emvUse.xlsx','카드사용정보샘플.xlsx');return false;">업로드샘플파일 다운로드</a>
	</span>
</div>
...
<div id="uploadResultDiv" style="display:none">
	<h4 class="tit">취업바우처카드 지급정보 일괄등록 결과</h4>
