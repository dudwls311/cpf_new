...
@Component("koreahanaFrmValidator")
public class KoreahanaFrmValidator extends ExtsAbstractValidator implements Validator {
	//validate체크할  field들
	...
	private static final String entcnyYmd = "entcnyYmd";		//입국연월
