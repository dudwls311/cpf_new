...
<table class="table_style thd_v_m">
  ...
  <tbody>
    <tr>
      <td>7</td>
      <td class="AlignLeft"><a href="/support/hanacenter/sup_history/0002/" class="btn_a">2022년 긴급생계비지원 모집(25차)</a></td>
      <td>yyyy-mm-dd hh:mm:ss</td>
      <td class="td_bg"><span class="txt_c_bk"><b>임시저장</b></span></td>
      <td><a href="/support/hanacenter/sup_history/0003" class="btn_st btn_c_wh">수정</a></td>
    </tr>
    <tr>
      <td>6</td>
    ...
    <tr>
      <td>3</td>
      <td class="AlignLeft"><a href="#" class="btn_a">취업바우처카드</a></td>
      <td>yyyy-mm-dd hh:mm:ss</td>
      <td class="td_bg"><span class="txt_c_bl"><b>선정</b></span></td>
      <td><a href="#" class="btn_st btn_c_wh">수정</a></td>
    </tr>
  ...
  <div class="popup_box SAMPLE_TOGGLE_HERE SAMPLE_POP_ON" style="width: 540px;">
    ...
    <div class="popup_con pop_b_none">
      ...
      <div class="btn_g_btm AlignCenter MAT0 MAB0">
        <a class="btn_st btn_c_gr btn_s_big" href="/support/hanacenter/sup_history/0003/">신청서 수정</a>
