...
<script type="text/javascript" src="/resources/js/exts/koreahana/sho/shoPrcExcelUpload.js"></script>
<form id="writeForm" action="${actionUrl }" method="post">
	<input type="hidden" name="kspMode" value="excelUploadActionJson" />
</form>
<form id="validationForm" action="${actionUrl }" method="post">
	<input type="hidden" name="kspMode" value="excelValidationActionJson" />
</form>
