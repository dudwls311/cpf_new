...
<script type="text/javascript" src="/resources/js/exts/koreahana/emp/empExcelUpload.js"></script>
<form id="writeForm" action="${actionUrl }" method="post">
	<input type="hidden" name="keMode" value="excelUploadActionJson" />
</form>
<form id="validationForm" action="${actionUrl }" method="post">
	<input type="hidden" name="keMode" value="excelValidationActionJson" />
</form>
	...
	<table class="table_style">
		<thead>
			<tr>
				...
				<th scope="col">주소</th>
				<th scope="col">학교명</th>
				<th scope="col">졸업상태</th>
				<th scope="col">전공명</th>
				<th scope="col">취업상태</th>
				<th scope="col">직장명</th>
				<th scope="col">지원동기 및 취업포부</th>
				<th scope="col">1종대형면허</th>
				<th scope="col">버스운전자격증</th>
				<th scope="col">희망 운수업체 </th>
			</tr>
		</thead>
