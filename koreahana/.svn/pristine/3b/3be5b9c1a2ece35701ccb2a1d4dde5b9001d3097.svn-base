...
<% 
	request.setCharacterEncoding("UTF-8");  // 한글깨지면 주석제거
 	...
 	String confmKey = (String)request.getAttribute("key"); // 검색API 승인키
	String domain = "https://10.182.60.20"; // 행정망
...
<script type="text/javascript" src="/resources/js/jusoPopup/addrlink.js"></script>
<link rel="stylesheet" type="text/css" href="/resources/css/jusoPopup/addrlink.css"></link>
...
<script language="javascript">
	...
	function jusoFindCheck(){
		...
		$.ajax({
			...
			,crossDomain:true
		    ,error: function(xhr,status, error){
		    	alert("주소검색 사용을 위해 매뉴얼 페이지로 이동됩니다.");
		    	//window.opener.open('/guide/etc/0007/0001/');
		    	location.href = '/guide/etc/0007/0001/';
		    }
		});
