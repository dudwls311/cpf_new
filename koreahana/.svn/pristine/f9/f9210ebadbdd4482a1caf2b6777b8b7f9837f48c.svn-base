...
//	}
	...
	protected void setIndexProcess(EnumMenuCd menuCd, HttpServletRequest request, String mode)
...
//					request.setAttribute(REQUEST_IS_PRNTG_AUTH,isPrntgAuth);
	 ...
	 * @param mode
	 */
	protected void setIndexProcess(EnumMenuCd menuCd, HttpServletRequest request, String orMode, String mode )
			throws SessionRequiredException, SessionRequiredJsonException, MenuAuthRequiredJsonException,MenuAuthRequiredException{
		setIndexProcess(menuCd, request, mode);
	}
	/**
